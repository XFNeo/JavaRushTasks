...
public class Solution {
    ...
    public static final String CAT_SERVICE = "service.cat";
    public static final String DOG_SERVICE = "service.dog";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            try {
                ...
                final Animal dog = new Dog("DOGGGG");
                final Animal cat = new Cat("CATTTT");
                Remote stabCat = UnicastRemoteObject.exportObject(cat, 0);
                registry.bind(CAT_SERVICE, stabCat);
                Remote stabDog = UnicastRemoteObject.exportObject(dog, 0);
                registry.bind(DOG_SERVICE, stabDog);

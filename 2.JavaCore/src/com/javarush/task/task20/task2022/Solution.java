...
public class Solution implements Serializable, AutoCloseable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Solution solution1 = new Solution("file");
        solution1.writeObject("solution1 str");
        ByteArrayOutputStream outArr = new ByteArrayOutputStream();
        ObjectOutputStream oos = new ObjectOutputStream(outArr);
        oos.writeObject(solution1);
        ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(outArr.toByteArray()));
        Solution solution2 = (Solution) ois.readObject();
        solution2.writeObject("solution2 str");
